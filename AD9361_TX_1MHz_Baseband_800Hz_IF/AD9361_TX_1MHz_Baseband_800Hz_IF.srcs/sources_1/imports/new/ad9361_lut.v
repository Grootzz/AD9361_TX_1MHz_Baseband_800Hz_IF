...
input [12 : 0] index;
	...
	begin
		case (index)
			...
			13'd2443:
				ad9361_cmd_data = {1'b1, 10'h1FB, 8'h05};
			13'd2444:
				ad9361_cmd_data = {1'b1, 10'h1FC, 8'h00};
			13'd2445:
				ad9361_cmd_data = {1'b1, 10'h1F8, 8'h13};
			13'd2446:
			...
			13'd2455:
				ad9361_cmd_data = {1'b1, 10'h0D6, 8'h10};
			13'd2456:
			...
			13'd2464:
				ad9361_cmd_data = {1'b1, 10'h1DB, 8'h60};
			13'd2465:
				ad9361_cmd_data = {1'b1, 10'h1DD, 8'h0A};
			13'd2466:
				ad9361_cmd_data = {1'b1, 10'h1DF, 8'h0A};
			13'd2467:
				ad9361_cmd_data = {1'b1, 10'h1DC, 8'h40};
			13'd2468:
				ad9361_cmd_data = {1'b1, 10'h1DE, 8'h40};
			13'd2469:
				ad9361_cmd_data = {1'b1, 10'h0D2, 8'h34};
			13'd2470:
				ad9361_cmd_data = {1'b1, 10'h0D1, 8'h0C};
			13'd2471:
				ad9361_cmd_data = {1'b1, 10'h0D0, 8'h56};
			13'd2472:
				ad9361_cmd_data = {1'b0, 10'h1EB, 8'h00}; 	// Read 0x1EB.
			13'd2473:
				ad9361_cmd_data = {1'b0, 10'h1EC, 8'h00}; 	// Read 0x1EC.
			...
			13'd2482:
				ad9361_cmd_data = {1'b1, 10'h207, 8'h7B};
			13'd2483:
				ad9361_cmd_data = {1'b1, 10'h208, 8'h48};
			13'd2484:
				ad9361_cmd_data = {1'b1, 10'h209, 8'h3B};
			13'd2485:
				ad9361_cmd_data = {1'b1, 10'h20A, 8'h4A};
			13'd2486:
				ad9361_cmd_data = {1'b1, 10'h20B, 8'h2D};
			13'd2487:
				ad9361_cmd_data = {1'b1, 10'h20C, 8'h4D};
			13'd2488:
				ad9361_cmd_data = {1'b1, 10'h20D, 8'h2B};
			13'd2489:
				ad9361_cmd_data = {1'b1, 10'h20E, 8'h00};
			13'd2490:
				ad9361_cmd_data = {1'b1, 10'h20F, 8'h7E};
			13'd2491:
				ad9361_cmd_data = {1'b1, 10'h210, 8'h7D};
			13'd2492:
				ad9361_cmd_data = {1'b1, 10'h211, 8'h7E};
			13'd2493:
				ad9361_cmd_data = {1'b1, 10'h212, 8'h48};
			13'd2494:
				ad9361_cmd_data = {1'b1, 10'h213, 8'h47};
			13'd2495:
				ad9361_cmd_data = {1'b1, 10'h214, 8'h48};
			13'd2496:
				ad9361_cmd_data = {1'b1, 10'h215, 8'h4B};
			13'd2497:
				ad9361_cmd_data = {1'b1, 10'h216, 8'h4A};
			13'd2498:
				ad9361_cmd_data = {1'b1, 10'h217, 8'h4B};
			13'd2499:
			...
			13'd2516:
				ad9361_cmd_data = {1'b1, 10'h0A0, 8'h15};
			13'd2517:
				ad9361_cmd_data = {1'b1, 10'h0A3, 8'h00};
			13'd2518:
